...
这是一个基于语义理解的Chrome书签搜索插件，能够理解搜索意图并找到相关的书签，而不仅仅是关键词匹配。

### 核心特性

- **语义搜索**: 基于TensorFlow.js和Universal Sentence Encoder实现真正的语义理解
- **完全本地化**: 所有计算在本地进行，保护隐私
- **智能理解**: 搜索"课本"能找到教育、学习、知识相关的所有书签
- **实时搜索**: 输入即搜索，500ms防抖优化
- **相关度排序**: 按照语义相似度智能排序结果
